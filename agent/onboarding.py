...
def openclaw_residue_hint_cli() -> str:
    ...
    Points users at ``simplicio-agent claw migrate`` (non-destructive port of config,
    memory, and skills) first. ``simplicio-agent claw cleanup`` is mentioned as the
    ...
    return (
        ...
        "`simplicio-agent claw migrate`.\n"
        "If you've already migrated and want to archive the old directory, "
        "run `simplicio-agent claw cleanup` (renames it to ~/.openclaw.pre-migration — "
