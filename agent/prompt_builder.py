...
KANBAN_GUIDANCE = (
    ...
    "every assignee in a real profile (`simplicio-agent profile list`, or ask the user), "
...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "first. It has the actual commands (e.g. `simplicio-agent config set …`, `simplicio-agent tools`, "
            "`simplicio-agent setup`) so you don't have to guess or invent workarounds.\n"
...
def build_nous_subscription_prompt(valid_tool_names: "set[str] | None" = None) -> str:
    ...
    lines.extend(
        [
            ...
            "Useful commands: simplicio-agent setup, simplicio-agent setup tools, simplicio-agent setup terminal, simplicio-agent status.",
        ]
    )
    return "\n".join(lines)
