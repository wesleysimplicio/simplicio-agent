...
_SKILL_REVIEW_PROMPT = (
    ...
    "  • Hub-installed skills (installed via 'simplicio-agent skills install').\n"
    "Pinned skills (marked via 'simplicio-agent curator pin') CAN be improved — "
...
def summarize_background_review_actions(
    ...
    for msg in review_messages or []:
        ...
        # Keep the upstream defensive guard: wrapper MCP servers may return
        # a list or scalar, while the remaining code only accepts a mapping.
