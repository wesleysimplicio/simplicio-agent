...
def invoke_tool(agent, function_name: str, function_args: dict, effective_task_id: str,
    ...
    if not pre_tool_block_checked:
        try:
            # Keep the long-standing public hook shim as the first check:
            # integrations (and older Simplicio plugins) patch or import this
            # entrypoint directly.  The richer resolver below still handles
            # Hermes' approval directive when the compatibility hook allows
            # the call through.
