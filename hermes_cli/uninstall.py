...
def uninstall_gateway_service():
    ...
    - All platforms: standalone ``simplicio-agent gateway run`` processes
...
#   4. On the ``simplicio-agent dashboard`` + gateway paths, drops files into
...
def _uninstall_profile(profile) -> None:
    ...
    We shell out to ``simplicio-agent -p <name> gateway stop|uninstall`` because
...
def run_gui_uninstall(args):
    ...
    Mirrors ``simplicio-agent uninstall --gui``. Removes the desktop app's built
    ...
    print(color("│         ⚕ Simplicio Agent Chat GUI Uninstaller           │", Colors.MAGENTA, Colors.BOLD))
    print(color("└─────────────────────────────────────────────────────────┘", Colors.MAGENTA, Colors.BOLD))
    print()

    if not summary["gui_installed"]:
        print("No Simplicio Agent Chat GUI installation was found.")
        print(f"  Checked: {hermes_home}, and the standard app locations for this OS.")
        return

    print(color("This removes the Chat GUI only. Simplicio Agent stays installed.", Colors.CYAN))
    print()
    ...
    if agent_is_installed(hermes_home):
        ...
        print(f"  • Simplicio Agent at {hermes_home / 'hermes-agent'}")
    ...
    print(color("└─────────────────────────────────────────────────────────┘", Colors.GREEN, Colors.BOLD))
    print()
    print("Simplicio Agent is still installed. Run 'simplicio-agent' to use the CLI,")
    print("or 'simplicio-agent uninstall' to remove the agent too.")
    print()
...
def run_uninstall(args):
    ...
    print()
    print(color("┌─────────────────────────────────────────────────────────┐", Colors.MAGENTA, Colors.BOLD))
    print(color("│          ⚕ Simplicio Agent Uninstaller                  │", Colors.MAGENTA, Colors.BOLD))
    print(color("└─────────────────────────────────────────────────────────┘", Colors.MAGENTA, Colors.BOLD))
    print()
    ...
    print()
    if full_uninstall:
        print(color("⚠️  WARNING: This will permanently delete ALL Simplicio Agent data!", Colors.RED, Colors.BOLD))
        ...
        print("This will remove the Simplicio Agent code but keep your configuration and data.")
...
def _perform_uninstall(
    *,
    ...
    print()
    print("Thank you for using Simplicio Agent! ⚕")
    print()
