...
_EPILOGUE = """
Examples:
    simplicio-agent                        Start interactive chat
    ...
    simplicio-agent debug share            Upload debug report for support
...
def build_top_level_parser():
    ...
    parser = argparse.ArgumentParser(
        ...
        description="Simplicio Agent - AI assistant with tool-calling capabilities",
    ...
    chat_parser = subparsers.add_parser(
        ...
        description="Start an interactive chat session with Simplicio Agent",
    )
