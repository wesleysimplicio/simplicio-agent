"""``simplicio-agent uninstall`` subcommand parser.
...
def build_uninstall_parser(subparsers, *, cmd_uninstall: Callable) -> None:
    ...
    uninstall_parser = subparsers.add_parser(
        "uninstall",
        help="Uninstall Simplicio Agent",
        description="Remove Simplicio Agent from your system. Can keep configs/data for reinstall.",
    )
