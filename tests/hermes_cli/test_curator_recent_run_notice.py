...
The notice prints the most recent curator run summary on `simplicio-agent update`,
...
session start) so users normally never see the rename map. `simplicio-agent update`
