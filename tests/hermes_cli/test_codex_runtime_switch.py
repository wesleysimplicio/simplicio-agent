...
class TestApply:
    ...
    def test_enable_succeeds_when_codex_present(self):
        ...
        assert "via MCP" in r.message  # simplicio-tools callback message
        assert cfg["model"]["openai_runtime"] == "codex_app_server"
    ...
    def test_enable_triggers_mcp_migration(self):
        ...
        with patch.object(crs, "check_codex_binary_ok",
            ...
            mig.return_value.migrated = ["filesystem", "simplicio-tools"]
        ...
        # User MCP servers are reported (excluding internal simplicio-tools)
