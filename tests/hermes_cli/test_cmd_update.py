...
class TestCmdUpdateBranchFlag:
    """``simplicio-agent update --branch <name>`` targets the requested branch.
...
class TestCmdUpdateCheckBranchFlag:
    """``simplicio-agent update --check --branch <name>`` honors the branch override.
...
class TestCmdUpdateZipBranchRefusal:
    """``simplicio-agent update --branch=<non-main>`` must refuse on the ZIP fallback path.
