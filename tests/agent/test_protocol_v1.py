...
def test_seq_is_monotonic_per_turn_id():
    ...
    seq_a_again = em.emit(PresentationEvent.PROGRESS.value, turn_id="A", attempt_id="1").seq
...
@pytest.mark.parametrize("bad", ["lifecycle.bogus", "presentation", "EXECUTION.TOOL", "", "control.nope"])
