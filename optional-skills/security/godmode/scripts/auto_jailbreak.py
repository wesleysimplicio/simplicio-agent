...
Usage in execute_code:
    exec(open(os.path.expanduser(
        os.path.join(os.environ.get("HERMES_HOME", os.path.expanduser("~/.simplicio_agent")), "skills/red-teaming/godmode/scripts/auto_jailbreak.py")
    )).read())
...
try:
    ...
    _SKILL_DIR = Path(os.getenv("HERMES_HOME", Path.home() / ".simplicio_agent")) / "skills" / "red-teaming" / "godmode"
...
HERMES_HOME = Path(os.getenv("HERMES_HOME", Path.home() / ".simplicio_agent"))
