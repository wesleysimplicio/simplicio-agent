...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Simplicio profile', surface: action('profile') },
  ...
  { name: '/version', description: 'Show Simplicio Agente version', surface: exec() },
