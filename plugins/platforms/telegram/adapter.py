...
class TelegramAdapter(BasePlatformAdapter):
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        # has been killed (e.g. during `simplicio-agent update` or `--replace` handoffs)
        ...
        message = (
            ...
            "with this token, then restart the gateway with 'simplicio-agent gateway restart'."
    ...
    def _build_provider_keyboard(self, providers: list, page: int = 0) -> tuple:
        ...
        CLI ``simplicio-agent model`` picker via the shared ``group_providers`` fold,
    ...
    async def _handle_gmail_triage_callback(
        ...
        *,
        ...
        script_path = _Path.home() / ".simplicio_agent" / "scripts" / "gmail-triage" / script_name
